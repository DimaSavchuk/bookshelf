 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];throw R.apply(void 0,[e].concat(t(h)(n)))}function A(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];return R.apply(void 0,[e].concat(t(h)(n)))}function C(e,r,n){var i=Object.assign(Object.assign({},x()),t(c)({},r,n));return new(0,g.ErrorFactory)("auth","Firebase",i).create(r,{appName:e.name})}function R(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];var a;if("string"!=typeof e){var o,s=n[0],u=t(h)(n.slice(1));return u[0]&&(u[0].appName=e.name),(o=e._errorFactory).create.apply(o,[s].concat(t(h)(u)))}return(a=I).create.apply(a,[e].concat(t(h)(n)))}function P(e,r){for(var n=arguments.length,i=new Array(n>2?n-2:0),a=2;a<n;a++)i[a-2]=arguments[a];if(!e)throw R.apply(void 0,[r].concat(t(h)(i)))}function L(e){var t="INTERNAL ASSERTION FAILED: "+e;throw S(t),new Error(t)}function N(e,t){e||L(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ae(e){var t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Le(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Ce(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(De(t))return"Blackberry";if(Me(t))return"Webos";if(Re(t))return"Safari";if((t.includes("chrome/")||Pe(t))&&!t.includes("edge/"))return"Chrome";if(Ne(t))return"Android";var r=e.match(/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/);return 2===(null==r?void 0:r.length)?r[1]:"Other"}function Ce(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:(0,g.getUA)();return/firefox\//i.test(e)}function Re(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:(0,g.getUA)(),t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Pe(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:(0,g.getUA)();return/crios\//i.test(e)}function Le(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:(0,g.getUA)();return/iemobile/i.test(e)}function Ne(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:(0,g.getUA)();return/android/i.test(e)}function De(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:(0,g.getUA)();return/blackberry/i.test(e)}function Me(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:(0,g.getUA)();return/webos/i.test(e)}function Ue(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:(0,g.getUA)();return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function je(){var e,t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:(0,g.getUA)();return Ue(t)&&!!(null===(e=window.navigator)||void 0===e?void 0:e.standalone)}function Fe(){return(0,g.isIE)()&&10===document.documentMode}function He(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:(0,g.getUA)();return Ue(e)||Ne(e)||Me(e)||De(e)||/windows phone/i.test(e)||Le(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var At=function(){"use strict";function e(r){t(s)(this,e),this.providerId=r,this.defaultLanguageCode=null,this.customParameters={}}return t(u)(e,[{key:"setDefaultLanguage",value:function(e){this.defaultLanguageCode=e}},{key:"setCustomParameters",value:function(e){return this.customParameters=e,this}},{key:"getCustomParameters",value:function(){return this.customParameters}}]),e}(),Ct=function(e){"use strict";t(p)(n,e);var r=t(v)(n);function n(){var e;return t(s)(this,n),(e=r.call.apply(r,[this].concat(Array.prototype.slice.call(arguments)))).scopes=[],e}return t(u)(n,[{key:"addScope",value:function(e){return this.scopes.includes(e)||this.scopes.push(e),this}},{key:"getScopes",value:function(){return t(h)(this.scopes)}}]),n}(At),Rt=function(e){"use strict";t(p)(n,e);var r=t(v)(n);function n(){return t(s)(this,n),r.call(this,"facebook.com")}return t(u)(n,null,[{key:"credential",value:function(e){return bt._fromParams({providerId:n.PROVIDER_ID,signInMethod:n.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}},{key:"credentialFromResult",value:function(e){return n.credentialFromTaggedObject(e)}},{key:"credentialFromError",value:function(e){return n.credentialFromTaggedObject(e.customData||{})}},{key:"credentialFromTaggedObject",value:function(e){var t=e._tokenResponse;if(!t||!("oauthAccessToken"in t))return null;if(!t.oauthAccessToken)return null;try{return n.credential(t.oauthAccessToken)}catch(e){return null}}}]),n}(Ct);
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Sn={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},On="_blank",An="http://localhost",Cn=function(){"use strict";function e(r){t(s)(this,e),this.window=r,this.associatedEvent=null}return t(u)(e,[{key:"close",value:function(){if(this.window)try{this.window.close()}catch(e){}}}]),e}();function Rn(e,r,n){var i=arguments.length>3&&void 0!==arguments[3]?arguments[3]:500,a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:600,o=Math.max((window.screen.availHeight-a)/2,0).toString(),s=Math.max((window.screen.availWidth-i)/2,0).toString(),u="",c=Object.assign(Object.assign({},Sn),{width:i.toString(),height:a.toString(),top:o,left:s}),l=(0,g.getUA)().toLowerCase();n&&(u=Pe(l)?On:n),Ce(l)&&(r=r||An,c.scrollbars="yes");var f=Object.entries(c).reduce((function(e,r){var n=t(d)(r,2),i=n[0],a=n[1];return"".concat(e).concat(i,"=").concat(a,",")}),"");if(je(l)&&"_self"!==u)return Pn(r||"",u),new Cn(null);var p=window.open(r||"",u,f);P(p,e,"popup-blocked");try{p.focus()}catch(e){}return new Cn(p)}function Pn(e,t){var r=document.createElement("a");r.href=e,r.target=t;var n=document.createEvent("MouseEvent");n.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),r.dispatchEvent(n)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ln=encodeURIComponent("fac");function Nn(e,t,r,n,i,a){return Dn.apply(this,arguments)}function Dn(){return(Dn=t(o)(t(m).mark((function e(r,n,i,a,o,s){var u,c,l,f,p,h,v,b,k,w,_,x,I,E,T,S,O,A,C;return t(m).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(P(r.config.authDomain,r,"auth-domain-config-required"),P(r.config.apiKey,r,"invalid-api-key"),u={apiKey:r.config.apiKey,appName:r.name,authType:i,redirectUrl:a,v:y.SDK_VERSION,eventId:o},!(n instanceof At)){e.next=24;break}for(n.setDefaultLanguage(r.languageCode),u.providerId=n.providerId||"",(0,g.isEmpty)(n.getCustomParameters())||(u.customParameters=JSON.stringify(n.getCustomParameters())),c=!0,l=!1,f=void 0,e.prev=8,p=Object.entries(s||{})[Symbol.iterator]();!(c=(h=p.next()).done);c=!0)v=t(d)(h.value,2),b=v[0],k=v[1],u[b]=k;e.next=16;break;case 12:e.prev=12,e.t0=e.catch(8),l=!0,f=e.t0;case 16:e.prev=16,e.prev=17,c||null==p.return||p.return();case 19:if(e.prev=19,!l){e.next=22;break}throw f;case 22:return e.finish(19);case 23:return e.finish(16);case 24:for(n instanceof Ct&&(w=n.getScopes().filter((function(e){return""!==e}))).length>0&&(u.scopes=w.join(",")),r.tenantId&&(u.tid=r.tenantId),_=u,x=!0,I=!1,E=void 0,e.prev=28,T=Object.keys(_)[Symbol.iterator]();!(x=(S=T.next()).done);x=!0)O=S.value,void 0===_[O]&&delete _[O];e.next=36;break;case 32:e.prev=32,e.t1=e.catch(28),I=!0,E=e.t1;case 36:e.prev=36,e.prev=37,x||null==T.return||T.return();case 39:if(e.prev=39,!I){e.next=42;break}throw E;case 42:return e.finish(39);case 43:return e.finish(36);case 44:return e.next=46,r._getAppCheckToken();case 46:return A=e.sent,C=A?"#".concat(Ln,"=").concat(encodeURIComponent(A)):"",e.abrupt("return","".concat(Mn(r),"?").concat((0,g.querystring)(_).slice(1)).concat(C));case 49:case"end":return e.stop()}}),e,null,[[8,12,16,24],[17,,19,23],[28,32,36,44],[37,,39,43]])})))).apply(this,arguments)}function Mn(e){var t=e.config;return t.emulator?F(t,"emulator/auth/handler"):"https://".concat(t.authDomain,"/").concat("__/auth/handler")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
